package cloud.lemonslice.solarterms.data.tag;
...
public final class NormalTags
{
    ...
    {
        public final static Tags.IOptionalNamedTag<Item> ARID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/arid_arid"));
        public final static Tags.IOptionalNamedTag<Item> ARID_DRY = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/arid_dry"));
        public final static Tags.IOptionalNamedTag<Item> ARID_AVERAGE = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/arid_average"));
        public final static Tags.IOptionalNamedTag<Item> ARID_MOIST = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/arid_moist"));
        public final static Tags.IOptionalNamedTag<Item> ARID_HUMID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/arid_humid"));
        public final static Tags.IOptionalNamedTag<Item> DRY = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/dry_dry"));
        public final static Tags.IOptionalNamedTag<Item> DRY_AVERAGE = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/dry_average"));
        public final static Tags.IOptionalNamedTag<Item> DRY_MOIST = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/dry_moist"));
        public final static Tags.IOptionalNamedTag<Item> DRY_HUMID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/dry_humid"));
        public final static Tags.IOptionalNamedTag<Item> AVERAGE = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/average_average"));
        public final static Tags.IOptionalNamedTag<Item> AVERAGE_MOIST = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/average_moist"));
        public final static Tags.IOptionalNamedTag<Item> AVERAGE_HUMID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/average_humid"));
        public final static Tags.IOptionalNamedTag<Item> MOIST = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/moist_moist"));
        public final static Tags.IOptionalNamedTag<Item> MOIST_HUMID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/moist_humid"));
        public final static Tags.IOptionalNamedTag<Item> HUMID = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/humid_humid"));

        public final static Tags.IOptionalNamedTag<Item> SPRING = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring"));
        public final static Tags.IOptionalNamedTag<Item> SUMMER = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/summer"));
        public final static Tags.IOptionalNamedTag<Item> AUTUMN = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/autumn"));
        public final static Tags.IOptionalNamedTag<Item> WINTER = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/winter"));
        public final static Tags.IOptionalNamedTag<Item> SP_SU = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_summer"));
        public final static Tags.IOptionalNamedTag<Item> SP_AU = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_autumn"));
        public final static Tags.IOptionalNamedTag<Item> SP_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_winter"));
        public final static Tags.IOptionalNamedTag<Item> SU_AU = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/summer_autumn"));
        public final static Tags.IOptionalNamedTag<Item> SU_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/summer_winter"));
        public final static Tags.IOptionalNamedTag<Item> AU_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/autumn_winter"));
        public final static Tags.IOptionalNamedTag<Item> SP_SU_AU = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_summer_autumn"));
        public final static Tags.IOptionalNamedTag<Item> SP_SU_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_summer_winter"));
        public final static Tags.IOptionalNamedTag<Item> SP_AU_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/spring_autumn_winter"));
        public final static Tags.IOptionalNamedTag<Item> SU_AU_WI = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/summer_autumn_winter"));
        public final static Tags.IOptionalNamedTag<Item> ALL_SEASONS = ItemTags.createOptional(new ResourceLocation(MODID + ":crops/all_seasons"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_BAMBOO = ItemTags.createOptional(new ResourceLocation("forge:seeds/bamboo"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_CACTUS = ItemTags.createOptional(new ResourceLocation("forge:seeds/cactus"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_GLOW_BERRY = ItemTags.createOptional(new ResourceLocation("forge:seeds/glow_berry"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_CHORUS_FLOWER = ItemTags.createOptional(new ResourceLocation("forge:seeds/chorus_flower"));
        public final static Tags.IOptionalNamedTag<Item> SEEDS_COCOA_BEAN = ItemTags.createOptional(new ResourceLocation("forge:seeds/cocoa_bean"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_KELP = ItemTags.createOptional(new ResourceLocation("forge:seeds/kelp"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_NETHER_VINE = ItemTags.createOptional(new ResourceLocation("forge:seeds/nether_vine"));
        public final static Tags.IOptionalNamedTag<Item> SEEDS_NETHER_WART = ItemTags.createOptional(new ResourceLocation("forge:seeds/nether_wart"));
        ...
        public final static Tags.IOptionalNamedTag<Item> SEEDS_SUGAR_CANE = ItemTags.createOptional(new ResourceLocation("forge:seeds/sugar_cane"));
